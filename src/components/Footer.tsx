  ...
  return (
    <footer id="contact" style={{ padding: '5rem 5% 3rem', maxWidth: '1000px', margin: '0 auto' }}>
      ...
      >
        ...
        <ContactCard href="https://github.com/Jamibhel" icon={<GithubIcon />} label="GitHub" />
        <ContactCard href="https://www.linkedin.com/in/bello-muh-jamiu-ishola-10371724a" icon={<LinkedinIcon />} label="LinkedIn" />
      </motion.div>
